...
const toolbarGroups: ToolbarGroup[] = [
  ...
  [
    ...
    { icon: ListTodo, label: "Task List", action: (e) => e.chain().focus().toggleTaskList().run(), isActive: (e) => e.isActive("taskList") },
  ],
  // Blocks
  [
    { icon: Quote, label: "Blockquote", action: (e) => e.chain().focus().toggleBlockquote().run(), isActive: (e) => e.isActive("blockquote") },
    { icon: FileCode, label: "Code Block", action: (e) => e.chain().focus().toggleCodeBlock().run(), isActive: (e) => e.isActive("codeBlock") },
  ...
  // History
  [
    { icon: Undo, label: "Undo", action: (e) => e.chain().focus().undo().run(), isDisabled: (e) => !e.can().undo() },
    { icon: Redo, label: "Redo", action: (e) => e.chain().focus().redo().run(), isDisabled: (e) => !e.can().redo() },
  ],
];
